      ...
      ! the procedures of the FORTRAN 2003 standard (used in read_command_line.F03)
      ! 
      ...
      CHARACTER(120)FLAG,VALOR,FREQFILE,MODLFILE !WARNINIG: FIXED LENGTH
      ...
      NARGS=IARGC() !COMMAND_ARGUMENT_COUNT()
      IF(NARGS==0)THEN
...
!         Listing help   
          CASE('h')
            ...
            PRINT*,'-gr     : Outputs group slowness -> Rgr.dat,Lgr.dat. Same file structure.'
